package org.johnragan.jms.multipleconsumers.topic;
...
public class OneTopicManyConsumers {
	Context jndiContext = null;
	ConnectionFactory connectionFactory = null;
	Destination destination = null;
	
	public OneTopicManyConsumers() {
		setup();
	}
	...
	public static void main(String[] args) {
		OneTopicManyConsumers oneTopicManyConsumers = new OneTopicManyConsumers();
		...
		TextMessage m3;
		try {
			m1 = (TextMessage)consumer1.receive();
			m2 = (TextMessage)consumer2.receive();
			m3 = (TextMessage)consumer3.receive();
