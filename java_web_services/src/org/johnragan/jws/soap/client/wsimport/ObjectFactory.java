 ...
 * generated in the org.johnragan.jws.soap.client.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _CountRabbitsResponse_QNAME = new QName("http://org.johnragan.jws.soap.server", "countRabbitsResponse");
    private final static QName _CountRabbits_QNAME = new QName("http://org.johnragan.jws.soap.server", "countRabbits");
    private final static QName _FibException_QNAME = new QName("http://org.johnragan.jws.soap.server", "FibException");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.johnragan.jws.soap.client.wsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.johnragan.jws.soap.server", name = "countRabbitsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.johnragan.jws.soap.server", name = "countRabbits")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://org.johnragan.jws.soap.server", name = "FibException")
