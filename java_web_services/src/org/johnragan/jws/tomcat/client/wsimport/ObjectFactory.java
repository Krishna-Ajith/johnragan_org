 ...
 * generated in the org.johnragan.jws.tomcat.client.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _F2C_QNAME = new QName("http://server.tomcat.jws.johnragan.org/", "f2c");
    private final static QName _C2F_QNAME = new QName("http://server.tomcat.jws.johnragan.org/", "c2f");
    private final static QName _F2CResponse_QNAME = new QName("http://server.tomcat.jws.johnragan.org/", "f2cResponse");
    private final static QName _C2FResponse_QNAME = new QName("http://server.tomcat.jws.johnragan.org/", "c2fResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.johnragan.jws.tomcat.client.wsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.tomcat.jws.johnragan.org/", name = "f2c")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.tomcat.jws.johnragan.org/", name = "c2f")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.tomcat.jws.johnragan.org/", name = "f2cResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.tomcat.jws.johnragan.org/", name = "c2fResponse")
