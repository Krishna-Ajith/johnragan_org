...
public class Lists {
    ...
    protected java.util.List<org.johnragan.awsClient.List> list;
     ...
     * {@link org.johnragan.awsClient.List }
     * 
     * 
     */
    public java.util.List<org.johnragan.awsClient.List> getList() {
        if (list == null) {
            list = new ArrayList<org.johnragan.awsClient.List>();
        }
        return this.list;
    }
