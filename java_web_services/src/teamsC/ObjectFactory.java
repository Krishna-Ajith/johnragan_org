...
public class ObjectFactory {
    ...
    private final static QName _GetTeamResponse_QNAME = new QName("http://richer.basics.jws.johnragan.org/", "getTeamResponse");
    private final static QName _GetTeam_QNAME = new QName("http://richer.basics.jws.johnragan.org/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://richer.basics.jws.johnragan.org/", "getTeams");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://richer.basics.jws.johnragan.org/", "getTeamsResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://richer.basics.jws.johnragan.org/", name = "getTeamResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://richer.basics.jws.johnragan.org/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://richer.basics.jws.johnragan.org/", name = "getTeams")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://richer.basics.jws.johnragan.org/", name = "getTeamsResponse")
