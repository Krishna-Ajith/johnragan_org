 ...
 * generated in the brownbagclient package. 
...
public class ObjectFactory {
    ...
    private final static QName _C2F_QNAME = new QName("http://provider.brownbag.jws.johnragan.org/", "c2f");
    private final static QName _F2CResponse_QNAME = new QName("http://provider.brownbag.jws.johnragan.org/", "f2cResponse");
    private final static QName _C2FResponse_QNAME = new QName("http://provider.brownbag.jws.johnragan.org/", "c2fResponse");
    private final static QName _F2C_QNAME = new QName("http://provider.brownbag.jws.johnragan.org/", "f2c");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: brownbagclient
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.brownbag.jws.johnragan.org/", name = "c2f")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.brownbag.jws.johnragan.org/", name = "f2cResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.brownbag.jws.johnragan.org/", name = "c2fResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://provider.brownbag.jws.johnragan.org/", name = "f2c")
